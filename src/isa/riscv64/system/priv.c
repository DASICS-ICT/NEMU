...
void init_csr() {
  ...
  #endif // CONFIG_RV_MPK
  #if defined (CONFIG_RV_DASICS) || defined (CONFIG_RV_MPK)
  MAP(DASICS_MPK_CSRS, CSRS_EXIST)
  #endif
  #ifdef CONFIG_RVH
  cpu.v = 0;
...
#else
#define MIP_MASK ((1 << 11) | (1 << 9) | (1 << 8) | (1 << 7) | (1 << 5) | (1 << 4) | (1 << 3) | (1 << 1) | (1 << 0))
#define MIE_MASK ((1 << 11) | (1 << 9) | (1 << 8) | (1 << 7) | (1 << 5) | (1 << 4) | (1 << 3) | (1 << 1) | (1 << 0))
#endif // CONFIG_RVH
#ifdef CONFIG_RVH
